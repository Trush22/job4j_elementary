...
class JavaNameValidatorTest {
    ...
    void specialSymbolTest() {
        assertThat(isSpecialSymbol(95)).isTrue();
    }

    @Test
    void upperLatinLetterTest() {
        assertThat(isUpperLatinLetter(70)).isTrue();
    }

    @Test
    void lowerLatinLetterTest() {
        assertThat(isLowerLatinLetter(122)).isTrue();
    }
